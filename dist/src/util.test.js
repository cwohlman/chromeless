...
ava_1.default('queue allows actions after an error', function (t) { return __awaiter(_this, void 0, void 0, function () {
    var chromeless, error, screenshot, regex;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                chromeless = new src_1.default({ launchChrome: false });
            ...
            case 2:
                _a.sent();
                return [4 /*yield*/, chromeless.screenshot()];
            case 3:
                screenshot = _a.sent();
                regex = new RegExp(os.tmpdir().replace(/\\/g, '\\\\'));
                t.regex(screenshot, regex);
